      ...
      <div className={styles.contentWrapper}>
        ...
        <div className={styles.pragraphContainer}>
          ...
          <p className={styles.txt}>
            ...
            afin que vous puissiez estimer le prix de votre projet
            {/* (il inclut unoutil d&#39;IA afin de pouvoir vous aider) */}
            . Vous pouvez ensuite le t&eacute;l&eacute;charger afin de prendre contact avec moi via ce
